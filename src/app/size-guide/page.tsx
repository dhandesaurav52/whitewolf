...
export const metadata: Metadata = {
  ...
  description: 'Find your perfect fit with our detailed size guides.',
};
  ...
  return (
    <div className="container mx-auto py-12">
        <div className="max-w-4xl mx-auto">
            <Card>
                <CardHeader>
                    <CardTitle className="text-center text-3xl font-bold font-headline text-accent">Size Guide</CardTitle>
