    ...
    const fetchProductData = async () => {
        ...
        try {
            ...
            if (foundProduct) {
                ...
                if (applicableAd) {
                    let productPrice = parseFloat(foundProduct.price);
                    let originalProductPrice = foundProduct.originalPrice ? parseFloat(foundProduct.originalPrice) : parseFloat(foundProduct.price);
                    let appliedDiscount = foundProduct.discount;
